---
date: '2026-08-04T11:04:04-07:00'
draft: false
...
{{< figure src="ticket-policy.png" alt="ticket policy" >}}
...
{{< figure src="ticket-app-trackers.png" alt="ticket app trackers" >}}
...
{{< figure src="fifa-contact-instructions.png" alt="FIFA contact instructions" >}}
...
I don't know what I, or anyone else, would've done if my phone was truly incompatible with the ticketing app. I wouldn't be surprised if FIFA has their own version of Errol Segal who could not attend a game because of technical difficulties.
...
The app's ratings were an early sign. As of writing this, about 230 of 306 ratings were 1 star.

{{< figure src="app-ratings.png" alt="FWC2026 Mobile ticket app ratings" >}}

As soon as I opened the app, it asked for permission to my photo gallery. I declined. It also asked for permission to my contacts. Declined. None of this is unusual even if it is invasive. After declining permissions, the app sent me to a browser login page. Not an uncommon design pattern, but one I do not like given how error prone it is. Which is exactly what I ran into. After filling in my credentials, I went back to the app... which promptly sent me back to the browser login. I lathered, rinsed, and repeated with no progress.
...
{{< figure src="freed-wristband.png" alt="commemorative wristband" >}}
...
More frustrating was the gift I received after the game. Because of the ticket package I got, FIFA gifted me a free laptop case.

{{< figure src="laptop-case.png" alt="commemorative laptop" >}}

Now this gift in itself is fine. I'll probably use this case. The card was almost certainly intended to be thrown away but I'll likely have it framed.

These gifts, though, irked me. An international soccer organization should give gifts geared towards, you know, soccer. Maybe something like a commemorative ticket.
...
{{< figure src="necklace.png" alt="USA laptop necklace" >}}
...
{{< figure src="replica-ticket.png" alt="replica ticket screenshot" >}}
...
{{< figure src="jerseys.png" alt="Jersey webstore screenshot" >}}
...
{{< figure src="attached-wristband.png" alt="wristband around my arm" >}}
...
{{< figure src="wristband-lock.png" alt="broken wristband lock" >}}
...
{{< figure src="survey-email.png" alt="survey invite screenshot" >}}
...
I tried to craft my response to pander to FIFA's true intent: maximizing profit. I intentionally made it sound as if FIFA was a great brand that I would happily spend more money on if it ticket delivery was better. Let's see if it works.
